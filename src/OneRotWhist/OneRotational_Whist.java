...
public class OneRotational_Whist {
	...
	public static Boolean generateLabels_CP(OneRotational_Solution_Whist Solution) throws IloException {
		IloCP cpx = new IloCP();
		int n = Solution.getV();
	...
	public static Boolean generateLabels_CP_Choco(OneRotational_Solution_Whist Solution) throws ContradictionException {
	...
	public ArrayList<OneRotational_Solution_Whist> solve(ArrayList<Integer> tables) throws ErrorThrower, IloException, ContradictionException {
		...
		OneRotational_Solution_Whist Solution = null;
		ArrayList<OneRotational_Solution_Whist> Solutions = new ArrayList<OneRotational_Solution_Whist>();
		...
		while (Flag) {
			...
			Solution = new OneRotational_Solution_Whist(tables, V);
	...
	public OneRotational_Whist(boolean Verbose, int SolLimit, Boolean exportModels, String FilePath, Boolean TimeLimit, Boolean Choco) {
	...
	public static void param_setExportModels(Boolean exportModels) {
		OneRotational_Whist.exportModels = exportModels;
	}
