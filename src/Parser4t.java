	...
	public static void main(String[] args) throws ErrorThrower, IloException, IOException, ContradictionException {
		...
		for (CSVRecord csvRecord : csvParser) {
			if (csvRecord.get(2).equals("Solved")) {
				...
				TwoRotationalOdd_Solution Mod3Solution = new TwoRotationalOdd_Solution(tables, size);
				...
				TwoRotationalOdd_Solution_M0 Solutions_Mod0 = new TwoRotationalOdd_Solution_M0(Mod3Solution);
